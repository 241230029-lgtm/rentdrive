...
class VerifikasiPerpanjanganSewaRequest extends FormRequest
{
    /**
     * Hanya admin yang dapat memproses perpanjangan.
     */
    ...
    public function messages(): array
    {
        return [
            ...
            'alasan_penolakan.required_if' =>
                'Alasan penolakan wajib diisi ketika permintaan ditolak.',
